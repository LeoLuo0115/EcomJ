...
import com.skillup.infrastructure.jooq.UserApp;
...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The reference instance of <code>user-app.user</code>
     */
    ...
    /**
     * The column <code>user-app.user.user_id</code>.
     */
    ...
    /**
     * The column <code>user-app.user.user_name</code>.
     */
    public final TableField<UserRecord, String> USER_NAME = createField(DSL.name("user_name"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>user-app.user.password</code>.
     */
    ...
    /**
     * Create an aliased <code>user-app.user</code> table reference
     */
    ...
    /**
     * Create a <code>user-app.user</code> table reference
     */
    public User() {
